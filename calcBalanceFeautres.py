...
def calcFeatures(settings, measuringTwice, plotje, verbose = None):
...
def read_data(locInExcel, testType, subject, time, plotje, verbose):  
...
if __name__ == "__main__":
     calcFeatures(settings, measuringTwice = False, plotje = False, 
                   verbose = True
                   )       
